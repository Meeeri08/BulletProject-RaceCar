...
bool ModuleSceneIntro::Start()
{
	...
	Cube wall19(2, 10, 40);
	wall19.color.Set(1.0f, 0.0f, 0.0f);
...
update_status ModuleSceneIntro::Update(float dt)
{
	...
	Cube wall18(50, 10, 2);
	wall18.color.Set(1.0f, 0.0f, 0.0f);
	wall18.SetPos(120, 0, 70);
	wall18.Render();
